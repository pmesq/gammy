...
botaoInfoEl.addEventListener('click', function() {
  ...
  infoEl.innerHTML = '<button id="botao-fechar-info">X</button><br><p>Gammy é uma rede de jogos, que possui em sua atual versão de testes aproximadamente 2 jogos. O site possui um sistema de conquistas, que incentiva mais ainda o usuário a jogar. O site foi desenvolvido por Pedro César (Alface), Sammuel Reis (Sammy) e Samuel Simonetti (Sabonete).<br>Bem vindo ao gammy!</p>';
